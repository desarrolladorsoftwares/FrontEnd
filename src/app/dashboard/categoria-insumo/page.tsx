...
import type { Categoria } from '@/components/dashboard/categoria-insumo/categorias-table';
import AddCategoriaModal from '@/components/dashboard/categoria-insumo/AddCategoriaModal';
import { config } from '@/config';
import { handleDeleteCategoria } from "@/components/dashboard/categoria-insumo/ActionsCategoria";
import { CategoriasFilters } from '@/components/dashboard/categoria-insumo/categorias-filters';
import { CategoriasTable } from "@/components/dashboard/categoria-insumo/categorias-table";
import  ToastProvider  from "../../../components/alerts/ToastProvider";
import { toast } from 'react-toastify';


const CATEGORIA_API_BASE_URL = "http://localhost:8083/api/categoria-insumo";
    ...
    <Stack spacing={3}>
      ...
      <Stack direction="row" spacing={3}>
        <Stack spacing={1} sx={{ flex: '1 1 auto' }}>
          <Typography variant="h4">Lista de Categorias Insumos</Typography>
        </Stack>
        <div>
