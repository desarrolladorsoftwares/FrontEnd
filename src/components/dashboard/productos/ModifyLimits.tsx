    ...
    useEffect(() => {
        if (limite) {
            setFormData({
                ...
                efectivo_aproximado: limite.efectivo_aproximado,
            });
        } else {
            ...
            <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', backgroundColor: 'white', padding: '1rem', borderRadius: '18px' }}>
                ...
                <form>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={4}>
                            <TextField
                                name="efectivo_aproximado"
                                label="Efectivo Aproximado"
                                variant="outlined"
                                helperText={formErrors.efectivo_aproximado || ""}
                                value={formData.efectivo_aproximado}
                                onChange={handleChange}
                                disabled
                                fullWidth
                            />
